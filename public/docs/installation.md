...
Install the Dither Icon adapter into a shadcn project. The registry adds @unlocalhosted/dither-icons as a dependency and places a client-safe DitherIcon export in your components/ui directory.
...
> The adapter preserves the library’s React playback, reduced-motion behavior, and three materials. Use icons.json for valid names. Keep the real action, state, loading feedback, and accessible label on the host control.
