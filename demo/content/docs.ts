...
export const docs: Doc[] = [
  ...
  { slug: 'installation', title: 'In your project in minutes.', eyebrow: 'INSTALLATION', description: 'A React package from npm. A standalone SVG for everywhere else.', sections: [
