...
export default function HomePage() {
  ...
  return <>
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-actions"><a className="button primary" href="#collection">Find your icon<Glyph name="arrow" size={16} /></a><a className="button subtle" href={packageUrl}><Glyph name="code" size={16} />Get the library</a></div>
