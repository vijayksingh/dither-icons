...
function App() {
  ...
  return <div id="top" className="app" data-motion={motion} style={{ '--accent': color, '--icon-color': color, '--enter': `${TIMING.enter}ms`, '--exit': `${TIMING.dismiss}ms` } as CSSProperties}>
    ...
    <footer className="site-footer"><Link className="brand" href="/"><span className="brand-mark"><DitherIcon name="layers" size={23} animate={false} /></span>dither<span className="brand-muted">icons</span></Link><span>A little more human. By <a href="https://github.com/vijayksingh" target="_blank" rel="noopener noreferrer">Vijay Singh</a>.</span><nav aria-label="Footer navigation"><Link href="/docs">Documentation</Link><Link href="/ai">For AI agents</Link><a href="/llms.txt">llms.txt</a><a href="https://github.com/vijayksingh/dither-icons" target="_blank" rel="noopener noreferrer">Source code</a></nav></footer>
