// Regenerate from the repository root: npx tsx docs/motion-evidence/refinement-06-rework/render-reference.tsx
import React from 'react';
import {writeFileSync} from 'node:fs';
import {renderToStaticMarkup} from 'react-dom/server';
import {DitherIcon,type Texture} from '../../../src';

const names=['close','plus','lock','unlock'];
const rows:[number,Texture,number][]=[[112,'dither',100],[48,'dither',290],[24,'solid',405],[24,'outline',495]];
const svg=renderToStaticMarkup(<svg xmlns="http://www.w3.org/2000/svg" width="1020" height="590" viewBox="0 0 1020 590" role="img" aria-label="Close, Plus, Lock and Unlock at large and compact sizes">
