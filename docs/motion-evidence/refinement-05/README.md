...
**Settings correction:** the user rejected its interior spring arc. [Clean-center evidence](settings-clean-center/) supersedes Settings in the original captures and playback records below. The size/export SVG and PNG have been regenerated with the clean gear.
