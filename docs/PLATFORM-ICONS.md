...
Reading Focus advances a margin marker inside a soft-square reading timer, distinct from Learning Rhythm's weighted metronome and Gauge's calibrated needle. Start at Text places a caret beside a sentence and identifies its first word. Listen sends sound out of a rounded page, distinct from Volume's loudspeaker. Read Aloud centers microphone intake above a responding transcript; it never shares Listen's outward wave story. These bespoke drawings share only their contour/text/response stroke hierarchy (1.5/1.25/1 units), not another icon's artwork or performance.
...
Compare the **Cognimated reader** studio family and [revision checks and review limits](motion-evidence/cognimated-reader-refinement/README.md) before future call-site integration. User visual approval is still required.
