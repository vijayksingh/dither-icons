...
Refinement / 05 applies MOT-01/03/05/07/08/16 to everyday controls. Search uses one joined outer contour and keeps its optics inside the rigid lens. Home binds a whole-edge hinge and its matching light occluder to identical clocks; threshold light precedes the short floor spill. Settings meets a geometrically exact receiving spring before compression and response; its interior must not introduce clock-hand symbolism. User uses shallow oval foreshortening, a fixed shoulder base and a delayed greeting after the nod reverses. MOT-14 keeps search results, navigation, preference persistence and identity state under the host application's control.
