...
export const studies:Record<string,Study>={
 ...learningWorkflow,...learningPractice,...platformTools,...navigation,...files,...learning,...platformNavigation,...communication,...media,...development,...controls,...presence,...atmosphere,
