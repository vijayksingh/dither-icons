...
export const definitions = [
 ...
 def('eye','Interface','The eyelids blink over a steady iris, then reopen.',l([[2,11],[7,6],[16,6],[21,11],[16,16],[7,16],[2,11]]),r(10,9,4,5,'slide')),
 ...
 {...def('reading-focus','Learning','A timer engages before its reading marker advances one line.',...[READING_FOCUS_ART.case,READING_FOCUS_ART.stem,READING_FOCUS_ART.crown,READING_FOCUS_ART.marker,...READING_FOCUS_ART.lines].map(strokeVector)),label:'Reading Focus',keywords:['cognimated','reader','guided reading','timer','focused reading','paced']},
...
const vectors:Record<string,string[]>={
 ...
 sparkles:[SPARKLES_ART.main,SPARKLES_ART.satellite,SPARKLES_ART.companion],
